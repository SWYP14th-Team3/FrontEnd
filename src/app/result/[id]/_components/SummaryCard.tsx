...
function SummaryCard({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-xxxl border-4 border-white bg-secondary-5 px-4 py-5 drop-shadow-[0px_4px_10px_rgba(0,0,0,0.05)] md:gap-[22px] md:px-[29px] md:py-[24px]">
